...
public class Result {
    ...
    {
        return "ClassPojo [utc_offset = "+utc_offset+", formatted_address = "+formatted_address+", types = "+types+", website = "+website+", business_status = "+business_status+", icon = "+icon+", rating = "+rating+", address_components = "+address_components+", photos = "+photos+", url = "+url+", reference = "+reference+", user_ratings_total = "+user_ratings_total+", reviews = "+reviews+", name = "+name+", opening_hours = "+opening_hours+", geometry = "+geometry+", vicinity = "+vicinity+", adr_address = "+adr_address+", formatted_phone_number = "+formatted_phone_number+", international_phone_number = "+international_phone_number+", place_id = "+place_id+"]";
    }
}
