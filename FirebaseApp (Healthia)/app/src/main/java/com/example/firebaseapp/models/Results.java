...
//    }
    ...
    {
        return "ClassPojo [types = "+types+", business_status = "+business_status+", icon = "+icon+", rating = "+rating+", photos = "+photos+", reference = "+reference+", user_ratings_total = "+user_ratings_total+", price_level = "+price_level+", scope = "+scope+", name = "+name+", geometry = "+geometry+", vicinity = "+vicinity+", place_id = "+place_id+"]";
    }
}
