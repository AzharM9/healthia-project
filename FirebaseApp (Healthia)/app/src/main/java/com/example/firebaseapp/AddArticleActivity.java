...
public class AddArticleActivity extends AppCompatActivity {
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(title)) {
                    Toast.makeText(com.example.firebaseapp.AddArticleActivity.this, "Enter title...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(description)) {
                    Toast.makeText(com.example.firebaseapp.AddArticleActivity.this, "Enter description...", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void updateWithoutImage(String title, String description, String editPostId) {
        ...
        hashMap.put("uDp", dp);
        hashMap.put("aCategory", forumType);
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(com.example.firebaseapp.AddArticleActivity.this, "Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(com.example.firebaseapp.AddArticleActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void updateWithNowImage(String title, String description, String editPostId) {
        ...
        String filePathAndName = "Articles/" + "article_" + timeStamp;
    ...
    private void loadPostData(String editPostId) {
        ...
        Query fquery = reference.orderByChild("aId").equalTo(editPostId);
        fquery.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    //get data
                    forumType = "" + ds.child("aCategory").getValue();
                    editTitle = "" + ds.child("aTitle").getValue();
                    editDescription = "" + ds.child("aDescription").getValue();
...
//                                hashMap.put("aReplies", "0");
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();
                                                Toast.makeText(com.example.firebaseapp.AddArticleActivity.this, "Published", Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
